...
const ServerDetailsBlock = ({ className }: { className?: string }) => {
    ...
    return (
        <div className={classNames('grid grid-cols-6 gap-2 md:gap-4', className)}>
            ...
            <StatBlock icon={faMicrochip} title={'CPU使用率'} color={getBackgroundColor(stats.cpu, limits.cpu)}>
                {status === 'offline' ? (
            ...
            <StatBlock icon={faHdd} title={'ディスク使用率'} color={getBackgroundColor(stats.disk / 1024, limits.disk * 1024)}>
