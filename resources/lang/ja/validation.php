...
return [
    ...
    */
    ...
    'between' => [
        ...
        'file' => ':attribute は :min KBから :max KBの間である必要があります。',
        'string' => ':attribute は :min 文字から :max 文字の間である必要があります。',
        'array' => ':attribute の項目数は :min から :max 個の間である必要があります。',
    ],
    ...
    'mimes' => ':attribute は以下のタイプのファイルである必要があります: :values。',
    'mimetypes' => ':attribute は以下のタイプのファイルである必要があります: :values。',
    'min' => [
        'numeric' => ':attribute は :min 以上である必要があります。',
        'file' => ':attribute は :min KB以上である必要があります。',
